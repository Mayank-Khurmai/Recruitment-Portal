...
else
{
	...
	class admin_preview_email_all_user{
                ...
                <div style='width:100%; height:500px; padding:20px;'>
                    <form>    
                        <table width='80%' bgcolor='gray' cellpadding='4px' cellspacing='0px' style='margin: 0 auto; padding:10px; padding-left:15px; padding-right:15px'>
                            <tr>
                                <td><input type='email' disabled='disabled' required='required' style='width:100%; padding:5px' value='Sending to all Users'></td>
                            </tr>
                            <tr>
	...
	new admin_preview_email_all_user();
}
