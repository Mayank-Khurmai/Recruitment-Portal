...
else
{
	...
	class admin_preview_view_pending_user{
		private $db;
		private $query;
		private $response;
		private $data;
                ...
                while($data = $this->response->fetch_assoc())
                {
					echo "
                        <tr>
                            ...
                            <td style='padding-left:5px'>Pending</td>
                            <th style='padding-left:5px'><span class='uverify' style='cursor:pointer; color:red' data='".$data['email']."'>Verify</span></th>
						</tr>
                        ";
                     $x++;   
				}
	...
	new admin_preview_view_pending_user();
